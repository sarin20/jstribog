...
public class IntegrationTest {
    ...
    private final boolean shortVersion = false;

    @Test
    public void testInstallation() throws NoSuchAlgorithmException, NoSuchProviderException, UnsupportedEncodingException {
        if (Security.getProvider("JStribog") != null) {
            Security.addProvider(new StribogProvider());
        }
        MessageDigest md = MessageDigest.getInstance(shortVersion ? "Stribog256" : "Stribog512", "JStribog");
        byte[] bytes = new byte[]{
